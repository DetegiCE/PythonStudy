...
for strs in lsts:
    ...
    #level set
    driver.find_element_by_id('elite0LevelDisplay').send_keys("50")
    ...
    #level set
    driver.find_element_by_id('elite1LevelDisplay').send_keys("80")
    ...
    #level set
    driver.find_element_by_id('elite2LevelDisplay').send_keys("90")
    ...
    #skill3
    try:
        driver.find_element_by_xpath("//*[@id=\"skill-tabs\"]/li[3]/button").click()
    except:
        str = str + "(!!!SKILL3 ERROR!!!)\t"
        print(str+"\n\n")
        continue
    
    e = driver.find_elements_by_xpath("//*[@id=\"skill2\"]/div[1]/span")
    str = str + e[0].text + "\t"
    
    try:
        e = driver.find_elements_by_xpath("//*[@id=\"skill2level0stats\"]/tbody/tr[7]/td/div[3]")
        str = str + "(" + e[0].text + ")\t"
    except:
        str = str + "(!!!ERROR!!!)\t"
